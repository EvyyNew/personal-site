...
>>>>>>> 6078b5d2cc107192807dd8270085ed5e9d5d8d1c
    ...
    <section className="blurb">
      ...
      <div>
        ...
        <div>
          <div>
            <h4>Linguist Engineer</h4>
            <p>
              Combining linguistic expertise with engineering skills to optimize language model
              performance
            </p>
          </div>
          <div>
            <h4>Prompt Engineer</h4>
            <p>
              Designing and optimizing prompt strategies for AI models to enhance output quality
            </p>
          </div>
          <div>
            <h4>AI Trainer</h4>
            <p>
              Responsible for machine learning model training, fine-tuning, and performance
              evaluation
            </p>
          </div>
          <div>
            <h4>Data Labeling Specialist</h4>
            <p>
              Managing and executing high-quality data annotation projects
            </p>
          </div>
          <div>
            <h4>Localization Specialist</h4>
            <p>
              Providing multilingual localization solutions for global products
            </p>
          </div>
        </div>
      </div>
      <div>
        ...
        <div>
          <div>
            <h4>AI Fine-tuning</h4>
            <p>
              Extensive experience in deep learning model optimization and customized training
            </p>
          </div>
          <div>
            <h4>Speech Model Development</h4>
            <p>
              Proficient in Text-to-Speech (TTS) and Automatic Speech Recognition (ASR) technologies
            </p>
          </div>
          <div>
            <h4>Data Annotation &amp; Processing</h4>
            <p>
              Experienced in large-scale dataset annotation and quality control
            </p>
          </div>
          <div>
            <h4>Natural Language Processing (NLP)</h4>
            <p>
              Skilled in text analysis, language model training, and linguistic technology
              applications
            </p>
          </div>
        </div>
      ...
      <div>
        ...
        <ul>
          <li>
            <strong>Visa Status:</strong> Requires work visa sponsorship
          </li>
          <li>
            <strong>Position Type:</strong> Open to both internship and full-time opportunities
          </li>
          <li>
            <strong>Location:</strong> Flexible regarding location for the right opportunity
          </li>
        </ul>
      </div>
      <p>
        <em>
          I am committed to bridging linguistic theory with cutting-edge AI technology, bringing
          innovative solutions and professional technical contributions to the team.
        </em>
      </p>
    </section>
    <section id="footer">
