        ...
        <section className="career-objective" style={{ marginTop: '2rem' }}>
          ...
          <div style={{ marginBottom: '1.5rem' }}>
            ...
            <div style={{ display: 'grid', gap: '0.75rem' }}>
              {careerObjective.targetPositions.map((position, index) => (
          ...
          <div style={{ marginBottom: '1.5rem' }}>
            ...
            <div style={{ display: 'grid', gap: '0.75rem' }}>
              {careerObjective.coreExpertise.map((expertise, index) => (
                <div key={index} style={{ borderLeft: '2px solid #10b981', paddingLeft: '1rem' }}>
